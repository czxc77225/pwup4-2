...
class MeshViewer:
  def __init__(self, objLoader):
    """
    Display 3D SMPL model mesh using `pygame`.       #用pygame來展現smpl模型

    Prameter
    --------
    t2s: Instance of `tex2shape.Tex2Shape`

    thetas: A list of poses. (N, 1, 72) where N is number of motions   #theta代表一個動作  N代表有多少個動作

    """
    self.obj_loader = objLoader   #把obj檔load進meshviewer裡
...
if __name__ == '__main__':
  ...
  # path_to_obj    = 'characters/putin2/motions/walking/sequence'
  # video_path     = 'characters/putin2/motions/walking/video'
  # path_to_colors = 'characters/putin2/colors.npy'
  # path_to_faces  = 'characters/putin2/faces.npy'

  path_to_obj    = 'characters/testobj2/motions/walking/sequence'
  video_path     = 'characters/testobj/motions/walking/video'
  path_to_colors = 'characters/testobj/colors1.npy'
  path_to_faces  = 'characters/testobj/faces6.npy'

  # path_to_obj    = 'characters/levon/motions/walking/sequence'
  # video_path     = 'characters/levon/motions/walking/video'
  # path_to_colors = 'characters/levon/colors8.npy'
  # path_to_faces  = 'characters/levon/faces8.npy'
